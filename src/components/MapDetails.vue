  ...
  padraoTipo: [
    {
      ...
      tipo: "Eval",
      de: "HtmlNode.InnerText.ToLower().Contains(\"misto\") || HtmlNode.InnerText.ToLower().Contains(\"brid\") ? \"hibrido\" : HtmlNode.InnerText.ToLower().Contains(\"office\") || HtmlNode.InnerText.ToLower().Contains(\"remot\") ? \"homeoffice\" : \"presencial\"",
      para: ""
    }
  ]
};
