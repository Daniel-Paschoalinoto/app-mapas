  ...
  padraoTipo: [
    {
      ...
      tipo: "Eval",
      de: "HtmlNode.InnerText.ToLower().Contains(\"misto\") || HtmlNode.InnerText.ToLower().Contains(\"hibrido\") || HtmlNode.InnerText.ToLower().Contains(\"híbrido\") || HtmlNode.InnerText.ToLower().Contains(\"híbrida\") || HtmlNode.InnerText.ToLower().Contains(\"hibrida\") ? \"hibrido\" : HtmlNode.InnerText.ToLower().Contains(\"office\") || HtmlNode.InnerText.ToLower().Contains(\"remoto\") || HtmlNode.InnerText.ToLower().Contains(\"remota\") ? \"homeoffice\" : \"presencial\"",
      para: ""
    }
  ]
};
